...
def main():
    ...
    modelo_peso = 'pesos/ffc_resnet50_fc_only_bs32_ep20_lr00001_bal_20250727-061820.pth'
    batch_size = 32
    ...
    model.load_state_dict(torch.load(modelo_peso, map_location=device, weights_only=False))
